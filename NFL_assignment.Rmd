...
ggplot(exp.sum, aes(x = Experience, y = mean_salary, fill = year)) +
  ...
  labs(
    title = "Average Salary vs Experience in 2013 and 2024",
...
ggplot(side.sum, aes(x = Side, y = mean_salary, fill = year)) +
  ...
  scale_y_continuous(labels = function(x) x / 1e6,
                     name   = "Average Salary (millions)" ) +
  labs(
    title = "Average Salary vs Player Category in 2013 and 2024",
    x = "Player Category"
  )    
...
ggplot(position.sum, aes(x = Position, y = mean_salary, fill = year)) +
  ...
  scale_y_continuous(labels = function(x) x / 1e6,
                     name   = "Average Salary (millions)" ) +
  labs(
    title = "Average Salary vs Position in 2013 and 2024",
    x = "Position"
  )     
```
