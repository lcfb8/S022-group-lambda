...
# We need to reconcile these positions with the positions in our dataset, with help from ChatGPT to clarify which sub-positions fall into the broader position categories (initials added to the list below by Lydia). 

table(clean.dat$Position)

# Not clearly indicated on the list below:
# C   DE   FB   LS  NT     S   
...
#I want to create a new variable in my dataset that assigns the average career length to each player based on their position. I will use `case_when()` again to do this.
