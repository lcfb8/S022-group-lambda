...
```{r mean_weight_height, eval = FALSE}
# some code
...
ggplot(clean.dat, aes(x = Experience, y = logSal, color = Race)) +
  geom_point(aes(shape = Side)) +     # make points partly transparent (asked chatgpt)
  geom_smooth(method = "lm", se = FALSE) +        
  labs(
...
```{r plot_height_position, eval = FALSE}
